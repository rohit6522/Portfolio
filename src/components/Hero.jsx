...
const icons = {
  ...
  LeetCode: (
    <svg viewBox="0 0 24 24" width="17" height="17" fill="none">
      <path
        ...
        fill="#FFA116"
      />
      <path d="M9.5 12.5h9a1.1 1.1 0 0 0 0-2.2h-9a1.1 1.1 0 0 0 0 2.2Z" fill="#B3B3B3" />
    </svg>
  ),
  Discord: (
  ...
  Email: (
    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#F59E0B" strokeWidth="1.8">
   ...
   Resume: (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#0a0a0a" strokeWidth="2.2">
